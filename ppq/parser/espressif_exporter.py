...
class EspressifExporter(GraphExporter):
    ...
    def export(
        ...
        **kwargs: Any
        ...
        graph = self.prepare_graph(graph = graph, exporter_patterns = exporter_patterns)
    ...
    def prepare_graph(self,
                      graph: BaseGraph, 
                      exporter_patterns: List[OperationExporter]) -> BaseGraph:
    ...
    def export_graph(
        ...
        exponents = pattern_info.var_exponents
        layout = pattern_info.var_layout
        ...
        for variable in graph.variables.values():
            tensor_proto = self.build_variable_proto(variable, exponents, layout)
