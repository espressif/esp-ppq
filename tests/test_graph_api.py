...
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op1'], B=graph.operations['op2'])
...
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op1'], B=graph.operations['op2'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op8'], B=graph.operations['op2'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op2'], B=graph.operations['op3'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op3'], B=graph.operations['op4'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op9'], B=graph.operations['op5'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op10'], B=graph.operations['op5'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op5'], B=graph.operations['op6'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op6'], B=graph.operations['op7'])
processor = SearchableGraph(graph)
paths = processor.path_matching(
...
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op6'], B=graph.operations['op7'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op6'], B=graph.operations['op7'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op11'], B=graph.operations['op1'])
graph.create_link_with_op(variable=graph.create_variable(), A=graph.operations['op11'], B=graph.operations['op10'])
processor = GraphFormatter(graph)
